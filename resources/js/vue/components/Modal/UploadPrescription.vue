            ...
            <div class="modal-dialog">
                <div class="modal-content">
                        ...
                        <div class="row" id="form-offcanvas">
                          ...
                          <div class="row">
                            <div class="col-12"> 
                              ...
                              <p>Following fields are required in the CSV file:</p>
                               <p>
                            ...
                            <div v-if="file_type == '.xlsx'">
                              <p>Following fields are required in the XLS file:</p>
                               <p>
                    ...
                    <div class="modal-footer">
                      <button v-if="is_loading==0"  type="submit" class="btn btn-primary">Save</button>
                      <button v-else  type="submit" class="btn btn-primary">Laoding</button>
