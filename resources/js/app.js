(function(){
  ...
  const initDatatable = ({url, finalColumns, advanceFilter, drawCallback = undefined, orderColumn}) => {
    ...
    window.renderedDataTable = $('#datatable').DataTable({
      ...
      dom: '<"row align-items-center"><"table-responsive my-3 mt-3 mb-5 pb-1" rt><"row align-items-center data_table_widgets" <"col-md-6" l><"col-md-6" p>><"clear">',
      ajax: {
        "type"   : "GET",
        "url"    : url,
        "data"   : function( d ) {
