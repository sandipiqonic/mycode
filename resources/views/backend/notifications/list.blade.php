...
<div class="card-body overflow-auto card-header-border p-0 card-body-list max-17 scroll-thin">
    <div class="dropdown-menu-1 overflow-y-auto list-style-1 mb-0 notification-height">
        ...
        @endphp
        @if($notification->data['data']['notification_group']=='appointment')
        <div class="dropdown-item-1 float-none p-3 list-unstyled iq-sub-card  {{ $notification->read_at ? '':'notify-list-bg'}} ">
            <a href="{{ route('backend.clinic-appointments.clinicAppointmentDetail', ['id' => $notification->data['data']['id'] , 'notification_id' => $notification->id]) }}" class="">
                ...
                <div class="list-item d-flex">
                    ...
                    <div class="list-style-detail">
                        ...
                        <p class="text-body mb-1">Appointment received for <span class="text-primary">{{ ($notification->data['data']['appointment_services_names']) }}</span> service by <span class="text-black">{{ ($notification->data['data']['user_name']) }}</span></p>
                        <div class="d-flex justify-content-between">
                        ...
                        <p class="text-body mb-1">Appointment <span class="text-primary">#{{ ($notification->data['data']['id']) }}</span> has been Accepted.</p>
                        <div class="d-flex justify-content-between">
                            <p class="text-body">{{ $notification->created_at->format('d/m/Y') }}</p>
                            <p class="text-body">{{ $notification->created_at->format('h:i A') }}</p>
                        </div>
                        ...
                        <p class="text-body mb-1">Appointment <span class="text-primary">#{{ ($notification->data['data']['id']) }}</span> has been Rejected.</p>
                        <div class="d-flex justify-content-between">
                            <p class="text-body">{{ $notification->created_at->format('d/m/Y') }}</p>
                            <p class="text-body">{{ $notification->created_at->format('h:i A') }}</p>
                        </div>
                        ...
                        <p class="text-body mb-1">Appointment <span class="text-primary">#{{ ($notification->data['data']['id']) }}</span> has been Completed.</p>
                        <div class="d-flex justify-content-between">
                            <p class="text-body">{{ $notification->created_at->format('d/m/Y') }}</p>
                            <p class="text-body">{{ $notification->created_at->format('h:i A') }}</p>
                        </div>
                        ...
                        <p class="text-body mb-1">Appointment <span class="text-primary">#{{ ($notification->data['data']['id']) }}</span> has been Cancelled.</p>
                        <div class="d-flex justify-content-between">
                            <p class="text-body">{{ $notification->created_at->format('d/m/Y') }}</p>
                            <p class="text-body">{{ $notification->created_at->format('h:i A') }}</p>
                        </div>
                        ...
                        <p class="text-body mb-1">Appointment Request <span class="text-primary">#{{ ($notification->data['data']['id']) }}</span> has been Accepted.</p>
                        <div class="d-flex justify-content-between">
                            <p class="text-body">{{ $notification->created_at->format('d/m/Y') }}</p>
                            <p class="text-body">{{ $notification->created_at->format('h:i A') }}</p>
                        </div>
            ...
            <a href="{{ route('backend.clinic-appointments.clinicAppointmentDetail', ['id' => $notification->data['data']['id'] , 'notification_id' => $notification->id]) }}" class="">
                ...
                <div class="list-item d-flex">
                    ...
                    <div class="list-style-detail">                        
                        ...
                        <p class="text-body mb-1">New Service Request <span class="text-primary">{{ ($notification->data['data']['name']) }}</span> added by <span class="text-black">{{ $username }}</span></p>
                        <div class="d-flex justify-content-between">
                            <p class="text-body">{{ $notification->created_at->format('d/m/Y') }}</p>
                            <p class="text-body">{{ $notification->created_at->format('h:i A') }}</p>
                        </div>
                        @elseif($notification->data['data']['notification_type']=='new_request_service')
                        <p class="text-body mb-1">Accept Service Request <span class="text-primary">{{ ($notification->data['data']['name']) }}</span> by <span class="text-black">{{ $username }}</span></p>
                        <div class="d-flex justify-content-between">
                            <p class="text-body">{{ $notification->created_at->format('d/m/Y') }}</p>
                            <p class="text-body">{{ $notification->created_at->format('h:i A') }}</p>
                        </div>
                        @else
                        <p class="text-body mb-1">Rejected Service Request <span class="text-primary">{{ ($notification->data['data']['name']) }}</span> by <span class="text-black">{{ $username }}</span></p>
                        <div class="d-flex justify-content-between">
                            <p class="text-body">{{ $notification->created_at->format('d/m/Y') }}</p>
                            <p class="text-body">{{ $notification->created_at->format('h:i A') }}</p>
                        </div>
        ...
        <div class="dropdown-item-1 float-none p-3 list-unstyled iq-sub-card  {{ $notification->read_at ? '':'notify-list-bg'}} ">
            <a href="{{ route('backend.orders.show', ['id' => $item_id , 'notification_id' => $notification->id]) }}" class="">
                <div class="d-flex justify-content-between">
                    <h6>{{ $notification_type }}</h6>
                    <h6>{{ ($notification->data['data']['order_code']) ?? null}} </h6>
                </div>
                <div class="list-item d-flex">
                    <div class="me-3 mt-1">
