...
@section('content')
    ...
    <div class="row">
        <div class="tab-pane fade show active" id="nav-download_url" role="tabpanel" aria-labelledby="nav-home-tab"
            ...
            <div class="col-sm-12 mb-3">
                <label for="download_status" class="form-label">{{ __('video.lbl_download_status') }}</label>
            ...
            <div id="download_status_section" class="download_status_section d-none">
                <div class="row">
                    <div class="col-sm-12 mb-3">
                        <h5>{{ __('video.lbl_download_info') }}</h5>
                    </div>

                    <div class="row">

                        <div class="col-sm-6 mb-3">
                            {{ html()->label(__('video.lbl_video_download_type'), 'download_type')->class('form-control-label') }}
                            {{ html()->select(
                                    'download_type',
                        ...
                        <div class="col-sm-6 mb-3">
                            {{ html()->label(__('video.download_url'), 'download_url')->class('form-control-label') }}
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 mb-3">
                            <h5>{{ __('video.lbl_download_quality_info') }}</h5>
                        </div>

                        <div class="col-sm-12 mb-3">
                            <label for="enable_download_quality"
                                class="form-label">{{ __('video.lbl_qaulity_info_message') }}</label>
                            <div class="form-check form-switch">
                                    ...
                                    @foreach ($data['entertainmentDownloadMappings'] as $mapping)
                                        <div class="row video-inputs-container">
                                            ...
                                            <div class="col-sm-4 mb-3">
                                                {{ html()->label(__('video.lbl_quality_video_download_type'), 'quality_video_download_type')->class('form-control-label') }}
                                                {{ html()->select(
                                            ...
                                            <div class="col-sm-4 mb-3 video-input">
                                                {{ html()->label(__('video.lbl_video_download_quality'), 'video_download_quality')->class('form-label') }}
                                                {{ html()->select(
                                            ...
                                            <div class="col-sm-4 mb-3 video-url-input" id="download_quality_video_url">
                                                {{ html()->label(__('video.download_quality_video_url'), 'download_quality_video_url')->class('form-control-label') }}
                                            ...
                                            <div class="col-sm-12 mb-3">
                                                <button type="button"
                                                    class="btn btn-danger remove-video-input d-none">Remove</button>
                                            </div>
                                        </div>
                                    @endforeach
                                @else
                                    <div class="row video-inputs-container">
                                        ...
                                        <div class="col-sm-4 mb-3 video-input">
                                            {{ html()->label(__('video.lbl_video_download_quality'), 'video_download_quality')->class('form-label') }}
                                            {{ html()->select('video_download_quality[]', $video_quality->pluck('name', 'value')->prepend('Select Quality', ''))->class('form-control select2')->id('video_download_quality') }}
    ...
    <a href="{{ route('backend.videos.index') }}" class="btn btn-secondary">Close</a>
