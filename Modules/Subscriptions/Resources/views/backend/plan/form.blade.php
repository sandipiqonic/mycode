...
<div class="card">
    <div class="card-body">
            ...
            <div class="row">
             ...
             <div class="row">
                ...
                @if($planLimit->slug=='device-limit')
                    <div>
                        <div class="col-sm-6 mb-3 d-none" id="deviceLimitInput">
                ...
                @if($planLimit->slug=='download-status')
                    <div>
                        <div class="col-sm-6 mb-3 d-none" id="DownloadStatus">
        ...
        <a href="{{ route('backend.plans.index') }}" class="btn btn-secondary">Close</a>
