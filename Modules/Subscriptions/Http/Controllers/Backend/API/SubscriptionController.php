...
class SubscriptionController extends Controller
{
    ...
    public function saveSubscriptionDetails(SubscriptionRequest $request)
    {
        ...
        $end_date = $this->get_plan_expiration_date($start_date, $plan['duration'], $active_plan_left_days, $plan['duration_value']);
        ...
        $this->sendNotificationOnsubscription('new_subscription', $items);  
        $response = [
