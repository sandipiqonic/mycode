<div class="d-flex gap-2 align-items-center">
  @hasPermission('edit_country')
       <a  class="btn btn-primary" href="{{ route('backend.country.edit', $data->id) }}"> <i class="fa-solid fa-pen-clip"></i></a>
...
@else
  <!-- Restore link -->
  <a class="restore-tax" href="{{ route('backend.country.restore', $data->id) }}">
