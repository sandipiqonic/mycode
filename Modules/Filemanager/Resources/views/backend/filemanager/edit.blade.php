...
<div class="card">
  <div class="card-body">
  {{ html()->form('POST' ,route('backend.filemanagers.update', $data->id))->attribute('enctype', 'multipart/form-data')->attribute('data-toggle', 'validator')->open() }}
        @csrf
        @method('PUT')
        <div class="row">
        ...
        <a href="{{ route('backend.filemanagers.index') }}" class="btn btn-secondary">Close</a>
