...
<div class="card">
 <div class="card-body">
    {{ html()->form('POST' ,route('backend.pages.store'))->attribute('enctype', 'multipart/form-data')->attribute('data-toggle', 'validator')->open() }}
      @csrf
      {{-- NAME row --}}
      <div class="row">
      ...
      <div class="row">
        <div class="col-sm-6 mb-3">
            {{ html()->label(__('page.lbl_description') . ' <span class="text-danger">*</span>', 'name')->class('form-control-label') }}
