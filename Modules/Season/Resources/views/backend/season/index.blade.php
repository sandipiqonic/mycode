    ...
    <div class="card-main mb-3">
            <x-backend.section-header>
                ...
                <div class="pt-5">
                            ...
                            <input type="checkbox" class="form-check-input" name="select_all_table" id="select-all-table" data-type="season" onclick="selectAllTable(this)">
                        </div>
                <x-slot name="toolbar">
            ...
            <div class="form-group datatable-filter">
                ...
                <select name="entertainment_id" id="entertainment_id" class="form-control select2" data-filter="select">
                    ...
                    @foreach ($tvshows as $tvshow)
                        <option value="{{ $tvshow->value }}">{{ $tvshow->name }}</option>
                    @endforeach
                </select>
            </div>
